...
@property(nonatomic, assign)float fahrenheitTemp;       //Fahrenheit degree  of temperature
@property(nonatomic, assign)float celiusTemp;           //Celius degree of temperature
